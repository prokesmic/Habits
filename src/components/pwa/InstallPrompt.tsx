...
export function InstallPrompt() {
  ...
  return (
    <div className="fixed bottom-20 left-4 right-4 z-[60] rounded-xl border-2 border-orange-500 bg-white p-6 shadow-2xl md:bottom-6 md:left-auto md:right-4 md:w-96">
      <button
